...
export const LandingHero: React.FC = () => {
	return (
		<section className='relative overflow-hidden'>
			<div
				aria-hidden
				className='pointer-events-none absolute inset-0 bg-[repeating-linear-gradient(90deg,transparent,transparent_72px,var(--border-primary)_72px,var(--border-primary)_73px)] opacity-30 [mask-image:linear-gradient(to_bottom,transparent,black_12%,black_70%,transparent)]'
			/>
			...
			>
				<div className='inline-flex items-center gap-2 rounded-full border-[0.5px] border-[var(--border-primary)] bg-[var(--muted)]/80 px-2.5 py-1 backdrop-blur-sm'>
					<AppIcon
				...
				<h1 className='mt-6 max-w-[630px] text-start md:text-center font-semibold tracking-[-0.04em] text-[36px] leading-[1.08] sm:text-[52px] text-[var(--foreground-primary)]'>
					Начните лучше понимать свои финансы
				</h1>

				<p className='mt-5 max-w-[630px] text-start md:text-center font-medium text-[15px] sm:text-[16px] leading-relaxed text-[var(--foreground-secondary)]'>
